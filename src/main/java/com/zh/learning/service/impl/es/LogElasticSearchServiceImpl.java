 ...
 */
@Service
public class LogElasticSearchServiceImpl implements LogElasticSearchService {
    @Autowired
...
//                "    }";
    ...
    @Override
    public Object addDoc(ElasticSearchLogAddIndexReq req) {
        //创建请求连接
        ...
        request.source(JSON.toJSONString(req.getLogPo()), XContentType.JSON);
        //通过客户端传递请求
        IndexResponse index;
        try {
